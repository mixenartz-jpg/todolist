  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center px-6 py-16 text-center">
      ...
      {actionLabel && actionHref && (
        <Link
          href={actionHref}
          className="mt-5 inline-flex h-10 items-center rounded-lg bg-[var(--color-accent-fill)] px-4 font-medium text-[var(--color-on-accent)] transition-[background-color,transform] duration-[var(--duration-fast)] ease-[var(--ease-out-expo)] hover:bg-[var(--color-accent-hover)] active:scale-[0.97]"
        >
          {actionLabel}
        </Link>
      )}
